...
gnuplot_svg = function (svgElement) {
    ...
    var extractedCoord = {
        'element': svgElement.getElementById('extracted_coord')
    }
    ...
    var setCoordinateLabel = function (evt) {
        ...
        // YCD modificaiton
        // Find y with given x
        //console.log(extractedCoord.element.innerHTML)
        curve = svgElement.getElementById('gnuplot_plot_2').querySelectorAll('path')[1].getAttribute('d')
        console.log(curve.split(/\s+/))
        extractedCoord.element.innerHTML = label.x
    };
